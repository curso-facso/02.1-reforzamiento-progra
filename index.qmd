...
![](imagenes/paper_ai_work.png){fig-align="center" width="600"}
...
$y_{it}$: productividad del trabajador $i$ en el tiempo $t$ 

$\delta_t$: fectos fijos de tiempo (impuestos, estación, etc.)

$\alpha_i$: efectos fijos del trabajador
...
![](imagenes/skill.png){fig-align="center" width="800"}


## experiencia

![](imagenes/tenure.png){fig-align="center" width="800"}

## curva-aprendizaje

![](imagenes/curva.png){fig-align="center" width="800"}
...
::: incremental
-   No es un reemplazo del analista
-   Se deben hacer las preguntas correctas
-   Se debe supervisar lo que hace GPT
-   No podemos perder el control de nuestro código
:::
...
Esta tecnología está disponible para hacer sus trabajos 

La tarea individual deberá hacerse "a la antigua" 
